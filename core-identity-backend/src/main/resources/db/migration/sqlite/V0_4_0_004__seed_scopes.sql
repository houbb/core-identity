...
INSERT OR IGNORE INTO identity_scope (id, scope_code, source_service, audience_code, name, description, risk_level, consent_display, assignable, status, created_at, updated_at, version)
VALUES
